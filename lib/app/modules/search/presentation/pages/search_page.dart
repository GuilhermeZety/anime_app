...
import 'package:anime_app/app/core/shared/animes/presentation/components/anime_item.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  Future search() async {
    loading = true;
    if (mounted) setState(() {});
    var response = await Modular.get<GetAnimes>()(GetAnimesParams(value: widget.controller.text));
